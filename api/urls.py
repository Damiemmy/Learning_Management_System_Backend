...
urlpatterns=[
    ...
    path("student/course-completed/",api_views.StudentCourseCompleteAPIView.as_view()),
    ...
    path("student/question-answer-create/",api_views.QuestionAnswerMessageSendAPIView.as_view()),
